...
def main():
    ...
    while(True):
        ...
        divsion_result =cv2.divide(imgBlur, bg, scale=255)   

        imgThreshold = cv2.adaptiveThreshold(divsion_result, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C,
        ...
        for pos in posList:
            ...
            # imgCrop = cv2.threshold(imgCrop, 0, 255, cv2.THRESH_BINARY_INV+cv2.THRESH_OTSU)[1]
