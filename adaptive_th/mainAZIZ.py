...
# Video feed
cap = cv2.VideoCapture('CVvideo_ver.mp4')
...
while True:
    ...
    next_frame_gray = cv2.fastNlMeansDenoising(frame_gray, None, 20, 7, 21)
    ...
    frame_diff = next_frame_gray - pre_frame_gray
    ...
    frameGrayRes = cv2.resize(frame_diff,(1280, 720), fx=0 ,fy=0)           # resizing perché la finestra di python taglia il video
